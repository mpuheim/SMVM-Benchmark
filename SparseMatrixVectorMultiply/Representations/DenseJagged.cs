...
{
    class DenseJagged : IMatrixConvertible, IVectorMultipliable, ISerializable
    {
        //matrix dimensions
        public int width;
        public int height;
        ...
        public DenseJagged(double[,] matrix)
        {
            init(matrix);
        }

        public DenseJagged(IMatrixConvertible matrixRepresentation)
        {
